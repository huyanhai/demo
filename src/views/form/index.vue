<template>
  <div class="page-form">
    ...
    <el-table v-loading="loading" :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="qlx" align="center"  label="材料规格" width="150"> </el-table-column>
      ...
      <el-table-column prop="NetWeight" align="center"  label="实际净重" width="100"> </el-table-column>
      <el-table-column prop="AddValue" align="center"  label="增加量" width="80"> </el-table-column>
      <el-table-column prop="PrintNetWeight" align="center"  label="打印净重" width="100"> </el-table-column>
      <el-table-column prop="U_name" align="center"  label="项目名称" width="150"> </el-table-column>
      <el-table-column prop="DevelopmentUnits" align="center"  label="客户单位" width="150"> </el-table-column>
      <el-table-column prop="Address" align="center"  label="工地地址" width="150"> </el-table-column>
...
<script>
import { GetSalesWeightList,GetWeightByID,DeleteWeightByID} from "@/api/Manage";
  ...
  methods: {
    printw(row){
       if(confirm("是否重新打印该磅单?")){
                ...
                axios.post('http://localhost:44321/api/api/Weigh/InPrintXC',queryParams).then(function (success) { //success 是自定义响应的参数名
                  //返回成功的响应
    ...
    previeww(row) {
      let queryParams = {utype:0,wType:4,ID:row.id}
      this.$refs.child.GetWeightByID(queryParams);
      this.showDialog=true;
    },
    updatew(row) {
      let queryParams = {utype:1,wType:4,ID:row.id}
      this.$refs.child.GetWeightByID(queryParams);
      this.showDialog=true;
    },
    deletew(row) {
    ...
    getList() {
      ...
      GetSalesWeightList(this.queryParams).then(res=>{
